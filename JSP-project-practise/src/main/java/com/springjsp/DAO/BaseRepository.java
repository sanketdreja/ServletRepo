...
public class BaseRepository {
	...
	public <E> List  findAll(String pojoName) {
		try {			
			javax.persistence.Query query = entityManager.createQuery(" from "+ pojoName); //its not sql, hence it is NOT select * from dept, rather it is select * from Department 
